...
display_welcome() {
  ...
  echo -e "${BLUE}[+]                  © LANSUGA OFFICIAL             [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${RED} [+] =============================================== [+]${NC}"
  echo -e ""
...
check_token() {
  ...
  if [ "$USER_TOKEN" = "Lansuga2" ]; then
    echo -e "${GREEN}𝗔𝗞𝗦𝗘𝗦 𝗕𝗘𝗥𝗛𝗔𝗦𝗜𝗟${NC}}"
  else
    echo -e "${GREEN}𝗕𝘂𝘆 𝗗𝘂𝗹𝘂 𝗪𝗸𝘄𝗸𝘄𝗸 𝗗𝗶 𝗟𝗮𝗻𝗴𝘀𝘂𝗴𝗮 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 @Wongarapp${NC}"
    exit 1
  fi
  clear
}
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg      Auto Installer Lansuga    ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------    ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : Wongarapp ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : Langsuga      ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Lansuga      ${NC}"
